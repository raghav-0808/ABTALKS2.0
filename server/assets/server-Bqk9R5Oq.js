...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Bn4WIipl.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DrXqpvlG.js").then((n) => n.t),
		import("./start-BSyaomot.js"),
...
var ROUTER_BASEPATH = "ABTALKS2.0";
var SERVER_FN_BASE = "/ABTALKS2.0/_serverFn/";
...
//# sourceMappingURL=server-Bqk9R5Oq.js.map